...
## 🚀 Full Stack Developer — Ko‘nikmalarim

### 🖥 Frontend

* ⚛️ **React** (Componentlar, Hooks, Routing)
...
* 🟩 **Node.js**
* 🟧 **NestJS** (Controller, Service, Module, CRUD)
* 🗄 **PostgreSQL / MySQL**
* 🔌 **REST API** yaratish
* 🔐 Auth (JWT, Guard)
...
* 🧩 React mini loyihalar
* 📄 Form validation ishlari
* 🎨 UI komponentlar (Tailwind)

### 🛠 Backend loyihalar

* 🔐 Auth + CRUD API (NestJS)
* 📦 Database bilan ishlovchi kichik servislar

---

## 🎯 Kelajak maqsadlarim

* 🔥 To‘liq Full Stack bo‘lish (React + NestJS + PostgreSQL)
* 🏗 Katta loyihalarda qatnashish
* 🧠 TypeScript va Clean Architecture chuqur o‘rganish
* 🚀 Portfolio uchun professional real loyihalar yaratish
